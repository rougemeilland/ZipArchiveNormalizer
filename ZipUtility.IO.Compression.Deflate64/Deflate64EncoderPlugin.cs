...
{
    public class Deflate64EncoderPlugin
        : Deflate64CoderPlugin, ICompressionHierarchicalEncoder
    {
            ...
            : HierarchicalEncoder
        {
            ...
            private static Deflate64EncoderStream GetBaseStream(IOutputByteStream<UInt64> baseStream, Int32 level, IProgress<UInt64>? progress)
            {
                if (baseStream is null)
                    throw new ArgumentNullException(nameof(baseStream));

                return
                    new Deflate64EncoderStream(
