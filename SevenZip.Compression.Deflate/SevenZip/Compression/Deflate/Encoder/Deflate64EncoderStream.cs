...
{
    public class Deflate64EncoderStream
        : IBasicOutputByteStream
    {
        private readonly InternalDeflateEncoderStream _stream;

        public Deflate64EncoderStream(IBasicOutputByteStream baseStream, Deflate64EncoderProperties properties, IProgress<UInt64>? progress, bool leaveOpen)
        {
