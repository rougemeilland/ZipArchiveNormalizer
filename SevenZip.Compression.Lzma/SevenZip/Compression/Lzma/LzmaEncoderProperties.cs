...
namespace SevenZip.Compression.Lzma
{
        ...
        : CoderProperties
    {
            ...
            bool IPropertiesNormalizer.IsValidValue(INormalizedPropertiesSource properties, Enum propertyId, object value)
            {
                return
                    propertyId switch
                    {
                        ...
                        PropertyId.DictionarySize => ((UInt32)value).IsBetween(1U << 12, 1U << 30),
                        ...
                        PropertyId.MatchFinder => ((MatchFinderType)value).IsAnyOf(/*MatchFinderType.HC4, MatchFinderType.HC5, */MatchFinderType.BT2, /*MatchFinderType.BT3, */MatchFinderType.BT4/*, MatchFinderType.BT5*/),
                        PropertyId.MatchFinderCycles => ((Int32)value).IsBetween(1, 1 << 30),
                        _ => true,
                    };
            }
        ...
        /// <summary>
        /// Specifies size of dictionary (0x1000 &lt;= <see cref="DictionarySize"/> &lt;= 0x40000000, default = 0x1000000).
        /// </summary>
        ...
        /// </summary>
        public Int32 MatchFinderCycles { get => (Int32)GetValue(PropertyId.MatchFinderCycles); set => SetValue(PropertyId.MatchFinderCycles, value); }
        ...
        public Int32 NumHashBytes => GetNumHashBytes(MatchFinder);
        ...
        private static Int32 GetNumHashBytes(MatchFinderType matchFinderType)
        {
